...
levels(data$asa)=c("I (normal healthy patient)","II (mild systemic disease without significant functional limitation)","III (severe systemic disease with significant functional limitation)","IV (severe systemic disease with constant threat to life)","V (critically ill patient not expected to survive without the operation)","Unknown")
levels(data$bmi)=c("Underweight BMI Below 18.5","Normal weight BMI 18.5-24.9","Pre-obesity BMI 25.0-29.9","Obesity class I BMI 30.0-34.9","Obesity class II BMI 35.0-39.9","Obesity class III BMI 40+","Unknown")
...
levels(data$op_operator)=c("Consultant or attending {op_operator_cons}","Senior trainee (i.e., senior registrar or resident with >4 years surgical training/residency)","Junior trainee (i.e., junior registrar or resident with ≤ 4 years surgical training/residency)","Non-surgeon (e.g., medical practitioner or nurse)")
...
levels(data$op_performed)=c("Total cholecystectomy {op_performed_tcs}","Subtotal cholecystectomy {op_performed_stc}","Not performed {op_performed_no}")
