...
# checkbox variables get collapsed and relabelled in 02_checkbox_variable_handling.R
...
data$op_anaes___3 %<>% ff_label("Sedation")
data$op_anaes___4 %<>% ff_label("General Inhaled")
data$op_anaes___5 %<>% ff_label("TIVA")
...
data$bdi_img___7 %<>% ff_label("Nuclear medicine scan")
