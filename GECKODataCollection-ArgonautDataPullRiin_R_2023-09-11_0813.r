...
# in addition, leading spaces in some label names removed.
library(finalfit)
...
data$post30_los %<>% ff_label("Length of stay  (Where discharge < 23 hours, enter 0. If the patient has not been discharged prior to the end of 30-day follow-up, enter 31)")
